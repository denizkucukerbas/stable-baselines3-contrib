...
Original file is located at
    https://colab.research.google.com/drive/1r69ibJMZE41Hb4MXZDSUDfdzBb8M2eBM
"""
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                target_quantiles = adjusted_rewards + (1 - replay_data.dones) * self.gamma * target_quantiles
